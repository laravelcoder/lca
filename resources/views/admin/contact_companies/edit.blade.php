        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="clinics">
                    ...
                    @empty
                        @foreach($contact_company->locations as $item)
                            @include('admin.contact_companies.locations_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="contacts">
                    ...
                    @empty
                        @foreach($contact_company->contacts as $item)
                            @include('admin.contact_companies.contacts_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="assets">
                    @forelse(old('assets', []) as $index => $data)
                        @include('admin.contact_companies.assets_row', [
                            'index' => $index
                        ])
                    @empty
                        @foreach($contact_company->assets as $item)
                            @include('admin.contact_companies.assets_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
