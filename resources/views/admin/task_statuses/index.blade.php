...
@section('content')
    ...
    <p>
        <a href="{{ route('admin.task_statuses.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a>
                        ...
                        @foreach ($task_statuses as $task_status)
                            <tr data-entry-id="{{ $task_status->id }}">
                                ...
                                <td field-key='name'>{{ $task_status->name }}</td>
                                    ...
                                    <a href="{{ route('admin.task_statuses.show',[$task_status->id]) }}" class="btn btn-xs btn-primary">@lang('quickadmin.qa_view')</a>
                                    @endcan
                                    @can('task_status_edit')
                                    <a href="{{ route('admin.task_statuses.edit',[$task_status->id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
                                    @endcan
                                    @can('task_status_delete')
{!! Form::open(array(
